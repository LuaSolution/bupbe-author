            ...
            <div class="col-lg-12 col-md-12">
                ...
                <div id="create-news" class="card updates">
                    <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="h2 bold"><a href="javascript:void(0)">Chỉnh sửa cửa hàng</a></h2>
                    </div>
                    <div id="create-box" class="show create-box card-body">
                        <form action="{{route('adpostEditStore', ['id' => $store->id])}}" method="POST" id="create-new"
                            class="form-create" enctype='multipart/form-data'>
                            {{ csrf_field() }}
                            <div class="form-group row">
                                <label class="col-sm-2 form-control-label">Tên cửa hàng:</label>
                                <div class="col-sm-10">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="form-avatar">@if($store->cover != "")
                                                {{substr($store->cover,0,strpos($store->cover,'?'))}} @else Choose file
                                                @endif </label>
                                        </div>
                                    </div>
                                    <img id="file-show" @if($store->cover != "")
                                    src="{{asset('/public/img/post/' .$store->cover)}}" @else class="hidden" @endif >
                                </div>
                            </div>
                            <div class="line"></div>
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="form-content-txt" class="text-content form-control"
                                            name="content">{!! $store->content !!}</textarea>
                                    </div>
                                    <script>
